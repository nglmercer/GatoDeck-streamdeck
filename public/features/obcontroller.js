...
const newhtmlobselement = document.createElement('dynamic-form');
newhtmlobselement.initialize()
    .addField({
        type: 'text',
        name: 'ip',
        label: 'IP',
    ...
    .render()
    .toggleDarkMode(true);
newhtmlobselement.reRender(defaultobsdata);
newhtmlobselement.addEventListener('form-submit', async (e) => {
...
export { mapedarrayobs, arrayobs,newhtmlobselement,functionsmoreused,executebykeyasync};
