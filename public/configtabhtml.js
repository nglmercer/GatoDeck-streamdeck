...
import { newhtmlobselement } from './features/obcontroller.js';
...
tabs.addContent(6,newhtmlobselement); // Agrega al tercer tab
tabs.setTabTitle(6,`${getTranslation('obs')}`);
//tabs.addContent(3,newhtmlobselement); // Agrega al tercer tab
